...
class Dataset_BP(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 seasonal_patterns=None,speeds=16,num_attentta=32,configs=None):
        if size == None:
            self.seq_len = 32
            self.label_len = 16
            self.pred_len = 16
        ...
        self.speeds=speeds
        self.num_attentta=num_attentta
    ...
    def __read_data__(self):
        ...
        speeds =self.speeds
        bs_attenna_numbers=self.num_attentta
        ...
        for i in range(file_range):
            for bs_attenna_number in bs_attenna_numbers:
                for speed in speeds:
                    ...
                    df_raw_snr=df_raw_snr.reshape(256,5,51)
                    ...
                    df_raw_phi = df_raw_phi.reshape(256, 1, 51)
